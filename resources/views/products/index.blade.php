                        ...
                        @foreach ($products as $item)
                            <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                                <x-product-card :product="$item">
                                    <a class="btn btn-outline-dark btn-square a-favorite-active" href="#">
                                        <button class="w-100 h-100 border-0 bg-transparent" type="submit"><i
                    ...
                    @else
                        @foreach ($products as $item)
                            @if (in_array($item->id, $favorites))
                                <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                                    <x-product-card :product="$item">
                                        <a class="btn btn-outline-dark btn-square a-favorite-fav" href="#">
                                            <button class="w-100 h-100 border-0 bg-dark" type="submit"><i
                                                    class="far fa-heart"></i></button>
                                        </a>
                                    </x-product-card>
                                </div>
