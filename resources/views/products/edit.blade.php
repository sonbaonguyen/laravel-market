        ...
        <div class="row px-xl-5">
            <div class="col mb-5">
                <div class="row contact-form bg-light p-30">
                    ...
                    <form class="col" method="POST" action="/products/{{$product->id}}/update" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-6">
                                <div class="control-group">
                                    ...
                                    <input type="name" class="form-control" id="name" name="name"
                                        required="required"
                                        data-validation-required-message="Please enter product name" value="{{$product->name}}" />
                                ...
                                <div class="control-group">
                                    ...
                                    <input type="short_description" class="form-control" id="short_description"
                                        name="short_description" required="required" value="{{$product->short_description}}"
                                ...
                                <div class="control-group">
                                    ...
                                    <input type="long_description" class="form-control" value="{{$product->long_description}}"
                                    id="long_description"
