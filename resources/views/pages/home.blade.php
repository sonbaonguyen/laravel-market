        ...
        <div class="row px-xl-5 pb-3">
            ...
            @foreach ($categories as $category)
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <a class="text-decoration-none" href="/products/?category={{ $category->name }}">
                        <div class="cat-item d-flex align-items-center mb-4">
                            ...
                            <div class="flex-fill pl-3">
                                <h6>{{ $category->name }}</h6>
                                <small class="text-body">Product Available</small>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            ...
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square" href="/products/{{ $item->id }}"><i
                                        class="fa fa-search"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate"
                                href="/products/{{ $item->id }}">{{ $item->name }}</a>
